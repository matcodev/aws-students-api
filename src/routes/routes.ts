...
export function RegisterRoutes(app: Router) {
    ...
    // ###########################################################################################################
        app.post('/students',
            ...
            async function StudentsController_createStudent(request: ExRequest, response: ExResponse, next: any) {
        ...
        app.get('/students',
            ...
            async function StudentsController_getStudents(request: ExRequest, response: ExResponse, next: any) {
            const args: Record<string, TsoaRoute.ParameterSchema> = {
            };
        ...
        app.get('/students/:id',
            ...
            async function StudentsController_getStudent(request: ExRequest, response: ExResponse, next: any) {
            const args: Record<string, TsoaRoute.ParameterSchema> = {
        ...
        app.put('/students/:id',
            ...
            async function StudentsController_updateStudent(request: ExRequest, response: ExResponse, next: any) {
            const args: Record<string, TsoaRoute.ParameterSchema> = {
                    id: {"in":"path","name":"id","required":true,"dataType":"string"},
        ...
        app.delete('/students/:id',
            ...
            async function StudentsController_deleteStudent(request: ExRequest, response: ExResponse, next: any) {
            const args: Record<string, TsoaRoute.ParameterSchema> = {
                    id: {"in":"path","name":"id","required":true,"dataType":"string"},
            };
